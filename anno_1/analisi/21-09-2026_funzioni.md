...
![Funzioni periodiche e funzioni trigonometriche](immagini/4.jpg)
...
$a<0$ è decrescente; se $a=0$ è costante. Al contrario dell'equazione di una retta non e' mai possibile rappresentare una retta verticale in quanto non violerebbe la definizione di funzione.  
...
il dominio esclude $0$. Ad esempio,
...
$$
x^{-\frac57}=\frac1{x^{5/7}}=\frac1{\sqrt[7]{x^5}}.
$$

![Funzioni potenza e radici](immagini/4.jpg)
...
Quando $a=e\simeq2{,}71$, si scrive semplicemente $\ln x$.

![Funzione esponenziale e funzione logaritmica](immagini/5.jpg)
...
![Funzioni trigonometriche e inverse](immagini/6.jpg)
