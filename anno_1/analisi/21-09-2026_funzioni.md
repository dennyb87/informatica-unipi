...
![Simmetria rispetto alla retta $y=x$](immagini/1.jpg)
...
![Definizioni e grafici delle funzioni monotone](immagini/1.jpg)
...
![Pendenza e funzione $f(x)=1/x$](immagini/2.jpg)
...
![Composizione di funzioni](immagini/2.jpg)

## Funzioni pari e dispari

Sia $A\subseteq\mathbb{R}$ **simmetrico rispetto all’origine**, cioè
...
![Funzioni pari e dispari](immagini/3.jpg)
...
$a<0$ è decrescente; se $a=0$ è costante.
